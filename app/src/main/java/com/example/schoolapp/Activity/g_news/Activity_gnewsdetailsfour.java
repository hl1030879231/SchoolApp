...
/**
 * Created by $HL on 2017/9/9.
 */

public class Activity_gnewsdetailsfour extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gnewsdetailsfour);
    ...
    public void showdetails(){
        gnews_one = (ScrollView)findViewById(R.id.birdknow);
        gnews_two = (ScrollView)findViewById(R.id.closedance);
        gnews_three = (ScrollView)findViewById(R.id.dragon);
        gnews_four = (ScrollView)findViewById(R.id.brush);
        gnews_five = (ScrollView)findViewById(R.id.family);
        gnews_six = (ScrollView)findViewById(R.id.concent);
