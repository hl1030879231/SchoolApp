...
public class Activity_gnewsdetailstwo extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gnewsdetailstwo);
    ...
    public void showdetails(){
        ...
        gnews_three = (ScrollView)findViewById(R.id.lundundaxue);
        gnews_four = (ScrollView)findViewById(R.id.hanguodaxue);
        gnews_five = (ScrollView)findViewById(R.id.ribenxuanba);
        gnews_six = (ScrollView)findViewById(R.id.jianadaxaunba);
