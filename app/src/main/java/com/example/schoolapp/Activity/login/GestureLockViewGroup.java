...
public class GestureLockViewGroup extends RelativeLayout {
     ...
     */
    private int mMarginBetweenLockView = 25;
    /**
     ...
     */
    private int mFingerOnColor = 0xFF939090;
    /**
     * GestureLockView手指抬起的状态下内圆和外圆的颜色
     */
    private int mFingerUpColor = 0xFF859CCD;
    ...
    public GestureLockViewGroup(Context context){super((context));}
