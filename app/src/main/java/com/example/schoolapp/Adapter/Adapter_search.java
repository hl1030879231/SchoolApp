...
public class Adapter_search extends BaseAdapter implements Filterable  {
    ...
    public Adapter_search(List<String> list, Context context, FilterListener filterListener) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.search_lvitem, null);
            holder = new ViewHolder();
            holder.tv_ss = (TextView) convertView.findViewById(R.id.searchitem_text);
