package com.example.schoolapp.Other_class;
...
public class PicsView extends RelativeLayout {
    ...
    private int pointsPosition = RelativeLayout.ALIGN_PARENT_RIGHT;
    private int titlePosition = RelativeLayout.ALIGN_PARENT_LEFT;
    ...
    private void initData() {
        ...
        RelativeLayout.LayoutParams llT = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
    ...
    private class AutoScrollTask implements Runnable {
        ...
        private void start() {
            mViewPager.postDelayed(this, timeDelayed);
        }
